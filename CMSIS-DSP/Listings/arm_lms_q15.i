...
#line 42 "src\\FilteringFunctions\\arm_lms_q15.c"
...
#line 146 "src\\FilteringFunctions\\arm_lms_q15.c"
  ...
  while(tapCnt > 0u)
  {
    ...
    *(*(int32_t __packed * *) & (pStateCurnt))++ = *(*(int32_t __packed * *) & (pState))++;
#line 253 "src\\FilteringFunctions\\arm_lms_q15.c"
...
#line 375 "src\\FilteringFunctions\\arm_lms_q15.c"
